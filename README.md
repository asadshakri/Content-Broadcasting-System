...
View My Content -> GET /content/my-contents
Response
{
"contents": [
{
...
View Approved Content -> GET /content/approved-contents
Response:
{
"contents": [
{
...
Schedule Approved Content -> POST /content/schedule-content/:id
Body:
{
"duration": 1
}
...
View All Content -> GET /principal/uploaded-contents
Response:
[
{
"id": 1,
...
Reject Content -> PATCH /principal/reject-content/:id
Body
{
...
View Pending Content -> GET /principal/pending-contents
Response
[
{
"id": 2,
...
Approve Content -> PATCH /principal/approve-content/:id
Body
{
